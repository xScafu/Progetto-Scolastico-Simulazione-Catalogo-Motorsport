...
public class CampionatoFormula1 {
	...
	public void letturaDatabase() {
		try {
			scuderie.clear();
			Reader databaseReader = new FileReader("database_campionatoFormula1.txt");
	...
	public void scritturaDatabase() {
		try {
			Writer databaseWriter = new FileWriter("database_campionatoFormula1.txt");
