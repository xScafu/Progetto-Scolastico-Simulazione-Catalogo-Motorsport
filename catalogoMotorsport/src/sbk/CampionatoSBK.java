...
public class CampionatoSBK {
	...
	public void letturaDatabase() {
		try {
			scuderie.clear();
			Reader databaseReader = new FileReader("database_campionatoSBK.txt");
	...
	public void scritturaDatabase() {
		try {
			Writer databaseWriter = new FileWriter("database_campionatoSBK.txt");
