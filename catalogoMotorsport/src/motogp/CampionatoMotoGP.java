...
public class CampionatoMotoGP {
	...
	public void letturaDatabase() {
		try {
			scuderie.clear();
			Reader databaseReader = new FileReader("database_campionatoMotoGP.txt");
	...
	public void scritturaDatabase() {
		try {
			Writer databaseWriter = new FileWriter("database_campionatoMotoGP.txt");
	...
	public void inizializzaScuderia() {
		...
		System.out.println("Inserire il numero di titoli costruttori vinti:");
